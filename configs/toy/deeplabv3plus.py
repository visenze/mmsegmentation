comment  = (
    "V2 (Only) White & Black BG Crop + BG AUG +  Load from DUTS-Full (Rerun 50 with different seeds) "
)
exp_name = "run52"
...
sod_data_root = '/home/tam.le/raid_04/data/ferrero_toys/sod_training/v2cleancrop_white_black/'
