comment  = (
    "V2 White & Black BG Crop + BG Aug + LovaszLoss (Finetune from DUTS-Full only CE Loss) "
)
exp_name = "run32"
...
log_level = 'INFO'
work_dir = f"/home/tam.le/raid_04/exp/ferrero_toys/semantic_seg/deeplabv3plus_r50/{exp_name}"
# load_from = "/home/tam.le/raid_04/exp/ferrero_toys/semantic_seg/deeplabv3plus_r50/run25/latest.pth"
